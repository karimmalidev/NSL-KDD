...
- Neural Network Models:
  - [x] Implement a basic Neural Network model.
  - Advanced Deep Learning Models:
    - [x] Recurrent Neural Network (RNN):
      - [x] Long Short-Term Memory (LSTM) or
      - [ ] Gated Recurrent Unit (GRU) with sequential data transformation.
    - [x] Convolutional Neural Network (CNN):
      - [x] Transform dataset to a format compatible with CNN.
  - [x] (Optional) Deep Reinforcement Learning (DRL):
    - [x] Convert dataset into states and actions.
    - [x] Create environment and train DRL model.
...
4. **Dataset:**
   - [x] Dataset used for the project.
